...
impl GaussianProcess
{
   ...
   pub fn new(training_inputs: DMatrix<f64>,
              training_outputs: DMatrix<f64>) -> GaussianProcessBuilder<kernel::Gaussian, prior::Constant>
   {
   ...
   fn default(training_inputs: DMatrix<f64>,
              training_outputs: DMatrix<f64>) -> GaussianProcessTrained<kernel::Gaussian, prior::Constant>
   {
      GaussianProcessBuilder::<kernel::Gaussian, prior::Constant>::new(training_inputs, training_outputs)
      .fit_kernel()
      .fit_prior()
